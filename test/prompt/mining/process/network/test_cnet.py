import unittest
from prompt.mining.process.network.cnet import CNet, CNode, InputBinding, OutputBinding, precision, recall, f1
import prompt.mining.process.network
from prompt.mining.process.network.graph import PathDoesNotExist
import logging
...
class CNetTestCase(unittest.TestCase):
    ...
    def test_get_network_from_json(self):
        ...
        the_net = prompt.mining.process.network.cnet.get_cnet_from_json(json)
