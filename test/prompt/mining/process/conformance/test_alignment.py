...
from prompt.mining.process.eventlog.factory import create_process_log_from_list
import prompt.mining.process.conformance.alignment as aln
from prompt.mining.process.conformance.alignment import Alignment
...
class AlignmentTestCase(unittest.TestCase):
    ...
    def test_optimal_alignment(self):
        ...
        case = ['a', 'b', 'c', 'd']
        log = create_process_log_from_list([case])
