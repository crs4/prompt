import unittest
from test.prompt.mining.process.discovery.heuristics import BackendTests
from prompt.mining.process.discovery.heuristics.all_connected import HeuristicMiner
import logging
import os
from prompt.mining.process.eventlog.factory import create_log_from_file, create_process_log_from_list
