...
from prompt.mining.process.eventlog.log import Log, LogInfo
from prompt.mining.process.eventlog import *
from prompt.mining.process.eventlog.exceptions import InvalidExtension
import os
...
def create_log_from_file(file_path, add_start_activity=True, add_end_activity=True, create_process=True):
    ...
    if ext == 'csv':
        ...
        from prompt.mining.process.eventlog.serializers.avro_serializer import deserialize_log_from_case_collection
