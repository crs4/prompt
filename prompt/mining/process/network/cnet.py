from prompt.mining.process.network import Node, Network, LabeledObject, UnexpectedEvent
from prompt.mining.process.network.graph import graph_factory
from prompt.mining.process.network.dependency import DependencyGraph
...
class CNet(DependencyGraph):
    ...
    def add_node(self, label, frequency=None, attrs=None):
        ...
        :return: a :class:`prompt.mining.process.network.cnet.CNode` instance
        """
        self.rewind()
    ...
    def add_input_binding(self, node, node_set, label='', frequency=None):
        ...
        :param node: a :class:`prompt.mining.process.network.cnet.CNode` instance
        :param node_set: a set of :class:`prompt.mining.process.network.cnet.CNode` instances
        :param label: a string associated to the binding
        :param frequency: initial frequency
        :return: a :class:`prompt.mining.process.network.cnet.InputBinding` instance
        """
        for n in node_set:
    ...
    def add_output_binding(self, node, node_set, label='', frequency=None):
        ...
        :param label: a string associated to the binding
        :param frequency: initial frequency
        :return: a :class:`prompt.mining.process.network.cnet.OutputBinding` instance
        """
        for n in node_set:
...
def get_cnet_from_json(json):
    ...
    :return: a :class:`prompt.mining.process.network.cnet.CNet` instance
    """
    try:
        origin = json[0]
        label = origin['label']
