...
import prompt.mining.process.network.bpmn.parser.process as p
from prompt.mining.process.network.bpmn.parser.process import ActivityDefinition
...
class XPDLHandler(xml.sax.handler.ContentHandler):
    ...
    def WorkflowProcess(self, attrs):
        ...
        process.defineDataFields(**self.package.dataFields)
