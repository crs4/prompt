...
class TransitionDefinition(object):
    ...
    interface.implements(interfaces.ITransitionDefinition, interfaces.IExtendedAttributesContainer)
...
class ProcessDefinition(object):
    ...
    interface.implements(interfaces.IProcessDefinition, interfaces.IExtendedAttributesContainer)
