package org.crs4.prom.heuristics;
...
public class ModifiedHeuristicsMiner {
	...
	public ModifiedHeuristicsMiner(XLog log) {
	...
	public ModifiedHeuristicsMiner(XLog log, XLogInfo logInfo) {
	...
	public ModifiedHeuristicsMiner(XLog log, XLogInfo logInfo, HeuristicsMinerSettings settings) {

		this(log, logInfo);
		this.settings = settings;
	}

	public ModifiedHeuristicsMiner(XLog log, HeuristicsMinerSettings settings) {
	...
	protected HeuristicsNet makeBasicRelations(HeuristicsMetrics metrics) {
